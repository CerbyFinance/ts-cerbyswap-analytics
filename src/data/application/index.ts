...
import { EthereumNetworkInfo, BinanceNetworkInfo, PolygonNetworkInfo, AvalancheNetworkInfo, FantomNetworkInfo } from 'constants/networks'
    ...
    variables: {
      name:
        activeNetwork === EthereumNetworkInfo
          ? 'CerbySwap/testGanache'
          : activeNetwork === BinanceNetworkInfo
          ? 'CerbySwap/Binance'
