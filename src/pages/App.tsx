        ...
        <AppWrapper>
          ...
          {subgraphStatus.available === false ? (
              ...
              <BodyWrapper>
                <DarkGreyCard style={{ maxWidth: '340px' }}>
                  <TYPE.label>
                    ...
                    current status{' '}
                    <ExternalLink href="https://thegraph.com/hosted-service/subgraph/cerby/cerbyswap">
                      here.
                    </ExternalLink>
                  </TYPE.label>
                </DarkGreyCard>
            ...
            <BodyWrapper warningActive={showNotSyncedWarning}>
              <Popups />
              <Switch>
                <Route exact strict path="/:networkID?/pools/:address" component={RedirectInvalidToken} />
                <Route exact strict path="/:networkID?/pools" component={TokensOverview} />
