...
import { NetworkInfo, PolygonNetworkInfo, BinanceNetworkInfo, FantomNetworkInfo, AvalancheNetworkInfo } from 'constants/networks'
...
export function getEtherscanLink(
  ...
  const prefix =
    networkVersion === PolygonNetworkInfo
      ...
      : networkVersion === BinanceNetworkInfo
      ? 'https://bscscan.com/'
      : networkVersion === FantomNetworkInfo
      ? 'https://ftmscan.com/'
